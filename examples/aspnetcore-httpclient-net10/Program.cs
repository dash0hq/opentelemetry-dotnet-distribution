...
// net10.0 twin of aspnetcore-httpclient, used to validate that instrumentation-image packaging changes don't
...
app.MapGet("/downstream", () =>
{
    ...
    return Results.Ok(new { message = "hello from downstream (net10.0)", timestamp = DateTimeOffset.UtcNow });
});
